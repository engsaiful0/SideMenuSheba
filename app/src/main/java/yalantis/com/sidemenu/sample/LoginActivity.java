...
import yalantis.com.sidemenu.sample.helper.DatabaseHandler;
import yalantis.com.sidemenu.sample.helper.SessionManager;
import yalantis.com.sidemenu.sample.helper.Functions;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // if (session.isLoggedIn()) {
            //Toast.makeText(getApplicationContext(),"Success login with this email",Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View view) {
                ...
                if (!email.isEmpty() && !password.isEmpty()) {
                    if (Functions.isValidEmailAddress(email)) {
                        ...
                        //Toast.makeText(getApplicationContext(), "Email is not valid!"+ loginProcess(email, password), Toast.LENGTH_SHORT).show();
                    } else {
    ...
    private void forgotPasswordDialog() {
        ...
        final EditText mEditEmail = dialogView.findViewById(R.id.lEditEmail);
