...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void logOut() {
        ...
        //Toast.makeText(getApplicationContext(),"tett",Toast.LENGTH_SHORT).show();
        logout.logoutUser(getApplicationContext());

        Intent startLoginActvity = new Intent(MainActivity.this, LoginActivity.class);
        startActivity(startLoginActvity);
    }
    /**
